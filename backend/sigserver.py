...
@app.route("/vsigverify", methods=[ 'POST'])
def verify():
    ...
    if 'file' not in request.files:
        js = "ERROR: File not found in upload"
    ...
    if file:
        ...
        js = "file upload success"

        text = getText(filename)
        # text = google_transcribe(filename)

        print(text)
        ver = verifypassword(text, "passwords.txt")
    ...
    # js = "ERROR: Tunnel Expired or Server Restart Required"
